            ...
            <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto"
                ...
                <div className="flex items-end justify-center min-h-[800px] sm:min-h-screen pt-4
                    ...
                    <Transition.Child
                        ...
                        leaveTo="opcaity-0 translate-y-4 sm:translate-y-0 sm:scale-95">
...
focus:ring-offset-2 focus:ring-2 focus:ring-red-500 sm:text-sm disabled:bg-gray-100 disabled:cursor-not-allowed
